...
import { ABOUT_PARTNERS, CONTACT_INFO, LOCATION_INFO, PartnerInfo } from './About.config';
        ...
        <div className="about">
            <div className="about__info">
                {LOCATION_INFO.map((info, i) => {
                    return (
                        <div key={info.name + i} className="about__info-item" style={{ left: info.x, top: info.y }}>
                            {info.img ? (
                                <img
                                    alt="origin"
                                    className={classnames('about__dot', `about__dot--${info.type}`)}
                                    src={info.img}
                                />
                            ) : (
                                <i className={classnames('about__dot', `about__dot--${info.type}`)}>
                                    <b
                                        style={{
